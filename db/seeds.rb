...
sound1.audio.attach(
    io: File.open('/home/sousman/Development/code/Mod5/project/beatcoderz/client/public/sound_files/kick1.wav'),
    filename: 'kick1.wav'
  )
sound2 = Sound.create(name:"lofi_snare1", user_id: 1, sound_pack_id: 1)
sound2.audio.attach(
    io: File.open('/home/sousman/Development/code/Mod5/project/beatcoderz/client/public/sound_files/snare1.wav'),
    filename: 'snare1.wav'
  )
sound3 = Sound.create(name:"lofi_hat1", user_id: 1, sound_pack_id: 1)
sound3.audio.attach(
    io: File.open('/home/sousman/Development/code/Mod5/project/beatcoderz/client/public/sound_files/hat1.wav'),
    filename: 'hat1.wav'
  )
sound4 = Sound.create(name:"lofi_perc1", user_id: 1, sound_pack_id: 1)
sound4.audio.attach(
    io: File.open('/home/sousman/Development/code/Mod5/project/beatcoderz/client/public/sound_files/perc1.wav'),
    filename: 'perc1.wav'
  )
