...
sound5.audio.attach(
    io: File.open(Rails.root.to_s + '/public/sound_files/kick2.wav'),
    filename: 'kick2.wav'
  )
sound6 = Sound.create(name:"synth_snare2", user_id: 1, sound_pack_id: 2)
sound6.audio.attach(
    io: File.open(Rails.root.to_s + '/public/sound_files/snare2.wav'),
    filename: 'snare2.wav'
  )
sound7 = Sound.create(name:"synth_hat2", user_id: 1, sound_pack_id: 2)
sound7.audio.attach(
    io: File.open(Rails.root.to_s + '/public/sound_files/hat2.wav'),
    filename: 'hat2.wav'
  )
sound8 = Sound.create(name:"synth2", user_id: 1, sound_pack_id: 2)
sound8.audio.attach(
    io: File.open(Rails.root.to_s + '/public/sound_files/synth2.wav'),
    filename: 'synth2.wav'
  )